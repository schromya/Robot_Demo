...
PKG_CONFIG_LIBRARIES_WITH_PREFIX = "-lfranka_human_friendly_controllers;/usr/lib/libfranka.so.0.9.2".split(';') if "-lfranka_human_friendly_controllers;/usr/lib/libfranka.so.0.9.2" != "" else []
