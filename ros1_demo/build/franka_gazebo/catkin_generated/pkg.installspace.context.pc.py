...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "${prefix}/include;/usr/include;/workspace/devel/share/orocos_kdl/cmake/../../../include;/usr/include/eigen3".split(';') if "${prefix}/include;/usr/include;/workspace/devel/share/orocos_kdl/cmake/../../../include;/usr/include/eigen3" != "" else []
