...
class Robot:
    ...
    def getLeftDistance(self) -> Float64: 
        msg = Float64()
        msg.data = self.leftDist
        return msg
    def getRightDistance(self) -> Float64: 
        msg = Float64()
        msg.data = self.rightDist
        return msg 
    def getHeading(self) -> Float64: 
        msg = Float64()
        msg.data = self.theta
        return msg 
    def getHeadingInDegrees(self) -> Float64: 
        msg = Float64()
        msg.data = self.theta / math.pi * 180
        return msg 
